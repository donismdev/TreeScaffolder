...
```
@@@FILE_BEGIN {{Root}}/Path@@@FILE_END@@@PATCH_BEGIN {{Root}}/Path@@@PATCH_END@@@FIND_BEGIN {{None}}@@@FIND_END@@@REPLACE_BEGIN {{None}}@@@REPLACE_END@@@INSERT_AFTER_BEGIN {{None}}@@@INSERT_AFTER_END@@@INSERT_BEFORE_BEGIN {{None}}@@@INSERT_BEFORE_END@@@INSERT_TOP_BEGIN {{None}}@@@INSERT_TOP_END@@@INSERT_BOTTOM_BEGIN {{None}}@@@INSERT_BOTTOM_END@@@REMOVE_BEGIN {{None}}@@@REMOVE_END@@@CLEAR_FILE_BEGIN {{Root}}/Path@@@CLEAR_FILE_END@@@CLEAR_AFTER_BEGIN {{None}}@@@CLEAR_AFTER_END@@@COMMENT_BEGIN {{None}}@@@COMMENT_END
```
...
```
@@@FIND_BEGIN / @@@FIND_END@@@REPLACE_BEGIN / @@@REPLACE_END@@@INSERT_AFTER_BEGIN / @@@INSERT_AFTER_END@@@INSERT_BEFORE_BEGIN / @@@INSERT_BEFORE_END@@@INSERT_TOP_BEGIN / @@@INSERT_TOP_END@@@INSERT_BOTTOM_BEGIN / @@@INSERT_BOTTOM_END@@@REMOVE_BEGIN / @@@REMOVE_END@@@CLEAR_AFTER_BEGIN / @@@CLEAR_AFTER_END@@@COMMENT_BEGIN / @@@COMMENT_END
```
